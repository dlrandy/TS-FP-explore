...
namespace lenses_demo_1 {
  ...
  const streetLens: Lens<Address, Street> = {
    ...
    set:(v: Street, o: Address) => new Address(
      o.city,v
    ) 
  }
  ...
  const streetNameLens = composeLenses(streetLens, nameLens);
    ...
    const address4 = streetNameLens.set(R.toUpper(address.street.name), address);
